...
public class ReturnBookController implements BasicController {
    ...
    public static void getLentBooksByCardNumber(String card_number){
    ...
    public ArrayList<BookLentHistory> getPickedLentBook() throws ParseException { //used for displaying rows after picked
